      ...
      <div className="land">
        <div className="img">
          <div className="firstText">
            <p>
              Empowering Education, Crafting Futures: Your Path to Innovative
              Curriculum Design
            </p>
        ...
        <div className="desgin">
          <div className="text">
            ...
            develop a course outline and build the course. Each learning
            objective is met with assessment strategies, exercises, content,
            subject matter analysis, and interactive activities.
          </div>
          <div className="imageD">
            <img
              src="https://img.freepik.com/free-vector/online-certification-concept_23-2148575665.jpg?w=740&t=st=1696310512~exp=1696311112~hmac=1c208deb04a2d0f7fa0b576a477aef0cd4d48114940141f792ec1bf1cbceea0d"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="compass">
          ...
          <p>
             A unified portal is required to collaborate with educational
            experts, curriculum designers to provide the functionality and
            design a model curriculum for all the Institutes.
          </p>
        ...
        <div className="contact">
          <h3>Contact Us</h3>
          <p>
            Head Office :Nelson Mandela Marg,Vasant Kunj, New Delhi-110070{" "}
            <br />
